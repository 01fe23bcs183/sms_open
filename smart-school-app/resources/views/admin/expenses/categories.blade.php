...
{{-- Prompt 256: Expense categories listing page with CRUD operations --}}
...
@section('content')
<div x-data="expenseCategoriesManager()">
    <!-- Page Header -->
        ...
        <div class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <select class="form-select" x-model="filters.sortBy">
                    ...
                    <option value="expenses_count">Expenses Count</option>
                    ...
                    @forelse($categories ?? [] as $category)
                        <tr x-show="matchesFilters({{ json_encode([
                            ...
                            <td class="text-center">
                                <span class="badge bg-light text-dark">{{ $category->expenses_count ?? 0 }}</span>
                            </td>
                            <td class="text-center">
                            ...
                            <td>
                                <div class="btn-group btn-group-sm">
                                    <a href="{{ route('expense-categories.edit', $category->id) }}" class="btn btn-outline-primary" title="Edit">
                                    ...
                                    <button 
                                        ...
                                        {{ ($category->expenses_count ?? 0) > 0 ? 'disabled' : '' }}
                                    >
                        ...
                        <tr>
                            <td colspan="7" class="text-center py-5">
                                <div class="text-muted">
                                    ...
                                    <p class="mb-2">No expense categories found</p>
                ...
                <form action="{{ route('expense-categories.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="code" required placeholder="e.g., EXP-001">
                        </div>
                        <div class="mb-3">
...
function expenseCategoriesManager() {
    return {
        ...
        confirmDelete(categoryId, categoryName) {
            this.deleteUrl = `/admin/expense-categories/${categoryId}`;
        ...
        toggleStatus(categoryId, currentStatus) {
            ...
            if (confirm(`Are you sure you want to ${newStatus === 'active' ? 'activate' : 'deactivate'} this category?`)) {
                ...
                form.action = `/admin/expense-categories/${categoryId}/toggle-status`;
                form.submit();
            }
        }
    };
